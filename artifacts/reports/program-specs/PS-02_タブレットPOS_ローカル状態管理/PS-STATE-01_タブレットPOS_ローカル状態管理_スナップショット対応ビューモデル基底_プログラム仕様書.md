...
| 名前空間 | Pos.Applications.Presentation.ViewModels.Base |
...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/pos-integration/Pos.Applications/Presentation/ViewModels/Base/SnapshotViewModelBase.cs |
