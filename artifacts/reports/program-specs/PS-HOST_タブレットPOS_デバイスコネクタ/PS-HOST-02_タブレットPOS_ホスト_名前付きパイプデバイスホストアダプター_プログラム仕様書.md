...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/TabletPosBoilerplate/TabletPos.Host/src/TabletHost/DeviceHost/NamedPipeDeviceHostAdapter.cs |
...
- 既定 pipe 名は `TabletPos.Host.Command` と `TabletPos.Host.Event`。
