...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/pos-integration/Pos.DeviceConnector/src/DeviceConnector/DeviceConnector/NamedPipeDeviceHostAdapter.cs |
...
- 既定 pipe 名は `Pos.DeviceConnector.Command` と `Pos.DeviceConnector.Event`。
