...
| 版数 | 日付 | 変更内容 | 作成者 | 承認者 |
| --- | --- | --- | --- | --- |
| 0.0.5 | 2026/08/24 | デバイス別の起動失敗保持と取得メソッドを追加し、現行ソースの異常追跡へ統一 | VTI サム | SMJ 蒲田 |
...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/TabletPosBoilerplate/TabletPos.Host/src/TabletDeviceManager/TabletDeviceManager.cs |
...
- GetStartupFailureがデバイス別の起動失敗内容をコマンド処理ハンドラーへ提供する。
