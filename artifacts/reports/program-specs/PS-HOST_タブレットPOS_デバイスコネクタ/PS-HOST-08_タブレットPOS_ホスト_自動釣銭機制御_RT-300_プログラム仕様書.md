...
| 版数 | 日付 | 変更内容 | 作成者 | 承認者 |
| --- | --- | --- | --- | --- |
| 0.0.5 | 2026/08/24 | DeviceUse／DeviceUnUseと強制復旧・入金セッション状態初期化を現行実装に合わせて追加 | VTI サム |  |
...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/TabletPosBoilerplate/TabletPos.Host/src/TabletDevice/CashChanger/CashChangerByRT300/CashChangerByRT300.cs |
