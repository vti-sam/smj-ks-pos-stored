...
| 版数 | 日付 | 変更内容 | 作成者 | 承認者 |
| --- | --- | --- | --- | --- |
| 0.0.5 | 2026/08/24 | 実行結果ログ出力とデバイス起動失敗詳細の応答を現行実装に合わせて更新 | VTI サム |  |
| 0.0.4 | 2026/07/23 | ARCH-HOST-01に合わせて、デバイスコネクタとコマンド実行部の表記を統一 | VTI サム |  |
| 0.0.3 | 2026/07/23 | デバイスコネクタ準備状態確認と失敗時ログを現行実装に合わせて更新 | VTI サム |  |
...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/TabletPosBoilerplate/TabletPos.Host/src/TabletHost/DeviceHost/DeviceCommandCore.cs |
