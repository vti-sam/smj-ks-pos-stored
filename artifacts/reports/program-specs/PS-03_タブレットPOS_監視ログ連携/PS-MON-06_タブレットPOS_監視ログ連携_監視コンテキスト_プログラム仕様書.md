...
| --- | --- |
| 文書ID | PS-MON-06 |
| 文書名 | タブレットPOS 監視ログ連携 監視コンテキスト プログラム仕様書 |
| 対象 | タブレットPOS / 監視コンテキスト |
| 版数 | 0.0.1 |
| 作成日 | 2026/06/21 |
| 作成者 | VTI サム, VTI 吉田 |
| レビュー担当 | SMJ 蒲田 |
...
| 項目 | 内容 |
| --- | --- |
| ソースファイル | sources/TabletPosBoilerplate/TabletPos.Core/Monitoring/MonitoringContext.cs |
...
| No | 可視性 | 戻り値 | メソッド名 | 概要 |
| --- | --- | --- | --- | --- |
| ① | public | - | MonitoringContext | 監視コンテキストを生成する。 |
