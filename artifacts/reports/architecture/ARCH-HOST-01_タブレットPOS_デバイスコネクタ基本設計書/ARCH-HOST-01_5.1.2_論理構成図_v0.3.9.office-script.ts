...
// Source contract SHA-256: 56d8553a769c953d009c844b7d50f3604e31d25be6a882ad61de1fcb059f70a6
...
function main(workbook: ExcelScript.Workbook) {
  ...
  const laneRange1 = getAnchoredRange(anchor, 0, 0, 1, 8);
  const laneRange2 = getAnchoredRange(anchor, 0, 8, 1, 12);
  const laneRange3 = getAnchoredRange(anchor, 0, 20, 1, 19);
  ...
  const geometryBottom = placeMermaidGeometry([shape_d512_HOST_HOST_EXEC_HOST_SETTING, shape_d512_HOST_HOST_EXEC_CONTROL, shape_d512_HOST_HOST_SERVICE_RUNTIME, shape_d512_DEVICE_DISPLAY, shape_d512_DEVICE_CASH, shape_d512_DEVICE_PRINTER, shape_d512_APP_APP_COORD_PROCESS, shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_DRAWER, shape_d512_DEVICE_PAYMENT, shape_d512_APP_APP_COORD_LIFECYCLE, shape_d512_HOST_HOST_EXEC_ORDER, shape_d512_APP_APP_ACCESS_SELECT, shape_d512_APP_APP_ACCESS_RESULT, shape_d512_APP_APP_COORD_BUSINESS, shape_d512_HOST_HOST_SERVICE_SERVER, shape_d512_HOST_HOST_SERVICE_EVENT, shape_d512_APP_APP_ACCESS_APP_SETTING, shape_d512_APP_APP_ACCESS_COMMAND, shape_d512_HOST_HOST_EXEC_MANAGER], [404.896886, 572.221886, 520.071389, 1059.845742, 786.1125, 1326.927816, 193.555266, 344.6625, 922.142496, 1195.875738, 193.555266, 572.221886, 133.007146, 133.007146, 56.6625, 520.071389, 641.277436, 133.007146, 133.007146, 488.559386], [193.7494, 193.7494, 488.57605, 66, 66, 66, 629.4637, 537.43495, 66, 66, 523.7143, 88, 185.7178, 381.1534, 629.4637, 594.32545, 594.32545, 88, 283.4356, 299.4988], anchor.getLeft(), originTop);
  ...
  addSectionBackground(sheet, "section_bg_d512_1_2", "② デバイス制御層", [shape_d512_APP_APP_ACCESS_SELECT, shape_d512_APP_APP_ACCESS_RESULT, shape_d512_APP_APP_ACCESS_APP_SETTING, shape_d512_APP_APP_ACCESS_COMMAND], laneRange1.getLeft(), laneRange1.getWidth(), 0, "", 1, "#ED7D31", 2, "#111111");
  ...
  addSectionBackground(sheet, "section_bg_d512_2_2", "② コマンド実行", [shape_d512_HOST_HOST_EXEC_HOST_SETTING, shape_d512_HOST_HOST_EXEC_CONTROL, shape_d512_HOST_HOST_EXEC_ORDER, shape_d512_HOST_HOST_EXEC_MANAGER], laneRange2.getLeft(), laneRange2.getWidth(), 0, "", 1, "#ED7D31", 2, "#111111");
  ...
  const edge_d512_02_APP_APP_ACCESS_APP_SETTING_to_APP_APP_ACCESS_SELECT = addConnector(sheet, "edge_d512_02_APP_APP_ACCESS_APP_SETTING_to_APP_APP_ACCESS_SELECT", shape_d512_APP_APP_ACCESS_APP_SETTING, shape_d512_APP_APP_ACCESS_SELECT, true, false, "②-4 アプリ側設定 → ②-1 設定・制御方式選択", "", "elbow", "left", "left", "#7F7F7F", 2);
  ...
  const edge_d512_04_APP_APP_ACCESS_COMMAND_to_APP_APP_ACCESS_RESULT = addConnector(sheet, "edge_d512_04_APP_APP_ACCESS_COMMAND_to_APP_APP_ACCESS_RESULT", shape_d512_APP_APP_ACCESS_COMMAND, shape_d512_APP_APP_ACCESS_RESULT, false, false, "②-2 コマンド通信 → ②-3 結果・イベント連携", "", "elbow", "", "", "#1F4E79", 2);
  ...
  const edge_d512_06_APP_APP_ACCESS_RESULT_to_APP_APP_COORD_BUSINESS = addConnector(sheet, "edge_d512_06_APP_APP_ACCESS_RESULT_to_APP_APP_COORD_BUSINESS", shape_d512_APP_APP_ACCESS_RESULT, shape_d512_APP_APP_COORD_BUSINESS, true, false, "②-3 結果・イベント連携 → ①-1 画面・業務処理", "", "elbow", "left", "left", "#C65911", 2);
  ...
  const edge_d512_16_HOST_HOST_SERVICE_EVENT_to_APP_APP_ACCESS_RESULT = addConnector(sheet, "edge_d512_16_HOST_HOST_SERVICE_EVENT_to_APP_APP_ACCESS_RESULT", shape_d512_HOST_HOST_SERVICE_EVENT, shape_d512_APP_APP_ACCESS_RESULT, true, false, "イベント通知用パイプ 非同期イベント", "イベント通知用パイプ 非同期イベント", "elbow", "left", "right", "#C65911", 2);
  const edge_d512_17_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_CASH = addConnector(sheet, "edge_d512_17_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_CASH", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_CASH, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7030A0", 2);
  const edge_d512_18_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DRAWER = addConnector(sheet, "edge_d512_18_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DRAWER", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_DRAWER, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7030A0", 2);
  const edge_d512_19_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DISPLAY = addConnector(sheet, "edge_d512_19_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DISPLAY", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_DISPLAY, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7030A0", 2);
  const edge_d512_20_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PAYMENT = addConnector(sheet, "edge_d512_20_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PAYMENT", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_PAYMENT, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7030A0", 2);
  const edge_d512_21_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PRINTER = addConnector(sheet, "edge_d512_21_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PRINTER", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_PRINTER, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7030A0", 2);
...
function addCellLaneTable(anchor: ExcelScript.Range, bodyEndRowOffset: number) {
  addLaneColumns(anchor, 0, 8, bodyEndRowOffset, "（1） タブレットPOS端末アプリ（アプリプロセス）", "#F7FBFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 8, 12, bodyEndRowOffset, "（2） デバイスコネクタ（Windows別プロセス）", "#FCE4D6", 0, "#ED7D31", 2, "#111111");
  addLaneColumns(anchor, 20, 19, bodyEndRowOffset, "（3） 周辺機器", "#E4DFEC", 0, "#8064A2", 2, "#111111");
}
