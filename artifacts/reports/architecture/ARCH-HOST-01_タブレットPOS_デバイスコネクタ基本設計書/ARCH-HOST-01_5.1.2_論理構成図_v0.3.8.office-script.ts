function main(workbook: ExcelScript.Workbook) {
  ...
  const baselineCanvasRowCount = 49;
  ...
  const shape_d512_APP_APP_ACCESS_RESULT = addTextShape(sheet, "shape_d512_APP_APP_ACCESS_RESULT", "②-3 結果・イベント連携", 0, 0, 134.325, 28, 10, true, "#F8FBFD", 0, "#0D32B2", 2, "#111111", true, "center", "roundRect", false);
  ...
  const shape_d512_APP_APP_ACCESS_APP_SETTING = addTextShape(sheet, "shape_d512_APP_APP_ACCESS_APP_SETTING", "②-4 アプリ側設定", 0, 0, 102.825, 28, 10, true, "#F8FBFD", 0, "#0D32B2", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d512_APP_APP_ACCESS_APP_SETTING, "②-4 アプリ側設定", "");
  ...
  let groupBottom1 = placeDiagramRow([shape_d512_APP_APP_COORD_BUSINESS], [0.5], laneRange1.getLeft(), originTop + 90, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_COORD_LIFECYCLE], [0.5], laneRange1.getLeft(), groupBottom1 + 60, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_COORD_PROCESS], [0.5], laneRange1.getLeft(), groupBottom1 + 60, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_ACCESS_SELECT], [0.5], laneRange1.getLeft(), groupBottom1 + 96, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_ACCESS_COMMAND], [0.5], laneRange1.getLeft(), groupBottom1 + 60, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_ACCESS_RESULT], [0.5], laneRange1.getLeft(), groupBottom1 + 60, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeDiagramRow([shape_d512_APP_APP_ACCESS_APP_SETTING], [0.5], laneRange1.getLeft(), groupBottom1 + 60, laneRange1.getWidth(), 30, 28);
  let groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_SERVICE_RUNTIME], [0.5], laneRange2.getLeft(), originTop + 90, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_SERVICE_SERVER], [0.5], laneRange2.getLeft(), groupBottom2 + 60, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_SERVICE_EVENT], [0.5], laneRange2.getLeft(), groupBottom2 + 60, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_EXEC_ORDER], [0.5], laneRange2.getLeft(), groupBottom2 + 96, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_EXEC_CONTROL], [0.5], laneRange2.getLeft(), groupBottom2 + 60, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_EXEC_MANAGER], [0.5], laneRange2.getLeft(), groupBottom2 + 60, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_EXEC_HOST_SETTING], [0.5], laneRange2.getLeft(), groupBottom2 + 60, laneRange2.getWidth(), 30, 28);
  groupBottom2 = placeDiagramRow([shape_d512_HOST_HOST_ADAPTER_ADAPTER], [0.5], laneRange2.getLeft(), groupBottom2 + 96, laneRange2.getWidth(), 30, 28);
  let groupBottom3 = placeDiagramRow([shape_d512_DEVICE_CASH], [0.5], laneRange3.getLeft(), originTop + 90, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeDiagramRow([shape_d512_DEVICE_DRAWER], [0.5], laneRange3.getLeft(), groupBottom3 + 60, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeDiagramRow([shape_d512_DEVICE_DISPLAY], [0.5], laneRange3.getLeft(), groupBottom3 + 60, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeDiagramRow([shape_d512_DEVICE_PAYMENT], [0.5], laneRange3.getLeft(), groupBottom3 + 60, laneRange3.getWidth(), 30, 28);

  addSectionBackground(sheet, "section_bg_d512_1_1", "① アプリケーション層\n（業務・プロセス管理）", [shape_d512_APP_APP_COORD_PROCESS, shape_d512_APP_APP_COORD_LIFECYCLE, shape_d512_APP_APP_COORD_BUSINESS], laneRange1.getLeft(), laneRange1.getWidth(), "", 1, "#ED7D31", 2, "#111111");
  addSectionBackground(sheet, "section_bg_d512_1_2", "② デバイス制御層", [shape_d512_APP_APP_ACCESS_SELECT, shape_d512_APP_APP_ACCESS_RESULT, shape_d512_APP_APP_ACCESS_APP_SETTING, shape_d512_APP_APP_ACCESS_COMMAND], laneRange1.getLeft(), laneRange1.getWidth(), "", 1, "#ED7D31", 2, "#111111");
  addSectionBackground(sheet, "section_bg_d512_2_1", "① プロセス・通信サービス", [shape_d512_HOST_HOST_SERVICE_RUNTIME, shape_d512_HOST_HOST_SERVICE_SERVER, shape_d512_HOST_HOST_SERVICE_EVENT], laneRange2.getLeft(), laneRange2.getWidth(), "", 1, "#ED7D31", 2, "#111111");
  addSectionBackground(sheet, "section_bg_d512_2_2", "② コマンド実行", [shape_d512_HOST_HOST_EXEC_HOST_SETTING, shape_d512_HOST_HOST_EXEC_CONTROL, shape_d512_HOST_HOST_EXEC_ORDER, shape_d512_HOST_HOST_EXEC_MANAGER], laneRange2.getLeft(), laneRange2.getWidth(), "", 1, "#ED7D31", 2, "#111111");
  addSectionBackground(sheet, "section_bg_d512_2_3", "③ 既存デバイス資源呼出し", [shape_d512_HOST_HOST_ADAPTER_ADAPTER], laneRange2.getLeft(), laneRange2.getWidth(), "", 1, "#ED7D31", 2, "#111111");
  ...
  const edge_d512_01_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_CASH = addConnector(sheet, "edge_d512_01_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_CASH", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_CASH, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d512_02_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DRAWER = addConnector(sheet, "edge_d512_02_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DRAWER", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_DRAWER, true, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#7F7F7F", 2);
  const edge_d512_03_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DISPLAY = addConnector(sheet, "edge_d512_03_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_DISPLAY", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_DISPLAY, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d512_04_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PAYMENT = addConnector(sheet, "edge_d512_04_HOST_HOST_ADAPTER_ADAPTER_to_DEVICE_PAYMENT", shape_d512_HOST_HOST_ADAPTER_ADAPTER, shape_d512_DEVICE_PAYMENT, false, true, "制御／結果", "制御／結果", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d512_05_APP_APP_COORD_PROCESS_to_HOST_HOST_SERVICE_RUNTIME = addConnector(sheet, "edge_d512_05_APP_APP_COORD_PROCESS_to_HOST_HOST_SERVICE_RUNTIME", shape_d512_APP_APP_COORD_PROCESS, shape_d512_HOST_HOST_SERVICE_RUNTIME, false, false, "OSプロセス制御", "OSプロセス制御", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d512_06_APP_APP_ACCESS_COMMAND_to_HOST_HOST_SERVICE_SERVER = addConnector(sheet, "edge_d512_06_APP_APP_ACCESS_COMMAND_to_HOST_HOST_SERVICE_SERVER", shape_d512_APP_APP_ACCESS_COMMAND, shape_d512_HOST_HOST_SERVICE_SERVER, false, true, "コマンド通信用パイプ 要求／同期応答", "コマンド通信用パイプ 要求／同期応答", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d512_07_HOST_HOST_SERVICE_EVENT_to_APP_APP_ACCESS_RESULT = addConnector(sheet, "edge_d512_07_HOST_HOST_SERVICE_EVENT_to_APP_APP_ACCESS_RESULT", shape_d512_HOST_HOST_SERVICE_EVENT, shape_d512_APP_APP_ACCESS_RESULT, false, false, "イベント通知用パイプ 非同期イベント", "イベント通知用パイプ 非同期イベント", "elbow", "left", "right", "#1F4E79", 2);
  const edge_d512_08_HOST_HOST_EXEC_MANAGER_to_HOST_HOST_ADAPTER_ADAPTER = addConnector(sheet, "edge_d512_08_HOST_HOST_EXEC_MANAGER_to_HOST_HOST_ADAPTER_ADAPTER", shape_d512_HOST_HOST_EXEC_MANAGER, shape_d512_HOST_HOST_ADAPTER_ADAPTER, true, false, "②-3 デバイス管理 → ③-1 ホスト内部実装", "", "elbow", "left", "left", "#7F7F7F", 2);
  const edge_d512_09_HOST_HOST_SERVICE_SERVER_to_HOST_HOST_EXEC_ORDER = addConnector(sheet, "edge_d512_09_HOST_HOST_SERVICE_SERVER_to_HOST_HOST_EXEC_ORDER", shape_d512_HOST_HOST_SERVICE_SERVER, shape_d512_HOST_HOST_EXEC_ORDER, false, false, "①-2 コマンド受付 → ②-1 デバイスID別順序制御", "", "elbow", "right", "right", "#1F4E79", 2);
  const edge_d512_10_HOST_HOST_EXEC_MANAGER_to_HOST_HOST_SERVICE_EVENT = addConnector(sheet, "edge_d512_10_HOST_HOST_EXEC_MANAGER_to_HOST_HOST_SERVICE_EVENT", shape_d512_HOST_HOST_EXEC_MANAGER, shape_d512_HOST_HOST_SERVICE_EVENT, false, false, "デバイス処理結果", "デバイス処理結果", "elbow", "left", "left", "#1F4E79", 2);
  const edge_d512_11_HOST_HOST_EXEC_HOST_SETTING_to_HOST_HOST_EXEC_MANAGER = addConnector(sheet, "edge_d512_11_HOST_HOST_EXEC_HOST_SETTING_to_HOST_HOST_EXEC_MANAGER", shape_d512_HOST_HOST_EXEC_HOST_SETTING, shape_d512_HOST_HOST_EXEC_MANAGER, false, false, "②-4 デバイスコネクタ側設定 → ②-3 デバイス管理", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d512_12_HOST_HOST_EXEC_ORDER_to_HOST_HOST_EXEC_CONTROL = addConnector(sheet, "edge_d512_12_HOST_HOST_EXEC_ORDER_to_HOST_HOST_EXEC_CONTROL", shape_d512_HOST_HOST_EXEC_ORDER, shape_d512_HOST_HOST_EXEC_CONTROL, false, false, "②-1 デバイスID別順序制御 → ②-2 要求変換・コマンド制御", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d512_13_HOST_HOST_EXEC_CONTROL_to_HOST_HOST_EXEC_MANAGER = addConnector(sheet, "edge_d512_13_HOST_HOST_EXEC_CONTROL_to_HOST_HOST_EXEC_MANAGER", shape_d512_HOST_HOST_EXEC_CONTROL, shape_d512_HOST_HOST_EXEC_MANAGER, true, false, "②-2 要求変換・コマンド制御 → ②-3 デバイス管理", "", "elbow", "", "", "#C65911", 2);
  const edge_d512_14_HOST_HOST_SERVICE_RUNTIME_to_HOST_HOST_SERVICE_SERVER = addConnector(sheet, "edge_d512_14_HOST_HOST_SERVICE_RUNTIME_to_HOST_HOST_SERVICE_SERVER", shape_d512_HOST_HOST_SERVICE_RUNTIME, shape_d512_HOST_HOST_SERVICE_SERVER, false, false, "①-1 起動・停止管理 → ①-2 コマンド受付", "", "elbow", "", "", "#548235", 2);
  const edge_d512_15_APP_APP_COORD_BUSINESS_to_APP_APP_ACCESS_SELECT = addConnector(sheet, "edge_d512_15_APP_APP_COORD_BUSINESS_to_APP_APP_ACCESS_SELECT", shape_d512_APP_APP_COORD_BUSINESS, shape_d512_APP_APP_ACCESS_SELECT, false, false, "①-1 画面・業務処理 → ②-1 設定・制御方式選択", "", "elbow", "left", "left", "#1F4E79", 3);
  const edge_d512_16_APP_APP_ACCESS_RESULT_to_APP_APP_COORD_BUSINESS = addConnector(sheet, "edge_d512_16_APP_APP_ACCESS_RESULT_to_APP_APP_COORD_BUSINESS", shape_d512_APP_APP_ACCESS_RESULT, shape_d512_APP_APP_COORD_BUSINESS, true, false, "②-3 結果・イベント連携 → ①-1 画面・業務処理", "", "elbow", "right", "right", "#C65911", 2);
  const edge_d512_17_APP_APP_ACCESS_APP_SETTING_to_APP_APP_ACCESS_SELECT = addConnector(sheet, "edge_d512_17_APP_APP_ACCESS_APP_SETTING_to_APP_APP_ACCESS_SELECT", shape_d512_APP_APP_ACCESS_APP_SETTING, shape_d512_APP_APP_ACCESS_SELECT, false, false, "②-4 アプリ側設定 → ②-1 設定・制御方式選択", "", "elbow", "left", "left", "#7030A0", 2);
  const edge_d512_18_APP_APP_ACCESS_SELECT_to_APP_APP_ACCESS_COMMAND = addConnector(sheet, "edge_d512_18_APP_APP_ACCESS_SELECT_to_APP_APP_ACCESS_COMMAND", shape_d512_APP_APP_ACCESS_SELECT, shape_d512_APP_APP_ACCESS_COMMAND, false, false, "②-1 設定・制御方式選択 → ②-2 コマンド通信", "", "elbow", "", "", "#7030A0", 2);
  const edge_d512_19_APP_APP_ACCESS_COMMAND_to_APP_APP_ACCESS_RESULT = addConnector(sheet, "edge_d512_19_APP_APP_ACCESS_COMMAND_to_APP_APP_ACCESS_RESULT", shape_d512_APP_APP_ACCESS_COMMAND, shape_d512_APP_APP_ACCESS_RESULT, false, false, "②-2 コマンド通信 → ②-3 結果・イベント連携", "", "elbow", "", "", "#7030A0", 2);
  const edge_d512_20_APP_APP_COORD_LIFECYCLE_to_APP_APP_COORD_PROCESS = addConnector(sheet, "edge_d512_20_APP_APP_COORD_LIFECYCLE_to_APP_APP_COORD_PROCESS", shape_d512_APP_APP_COORD_LIFECYCLE, shape_d512_APP_APP_COORD_PROCESS, false, false, "①-2 アプリライフサイクル → ①-3 デバイスコネクタ", "", "elbow", "", "", "#7030A0", 2);
...
function addCellLaneTable(anchor: ExcelScript.Range, bodyEndRowOffset: number) {
  addLaneColumns(anchor, 0, 9, bodyEndRowOffset, "（1） タブレットPOS端末アプリ（アプリプロセス）", "#F7FBFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 9, 8, bodyEndRowOffset, "（2） デバイスコネクタ（Windows別プロセス）", "#FCE4D6", 0, "#ED7D31", 2, "#111111");
  addLaneColumns(anchor, 17, 8, bodyEndRowOffset, "（3） 周辺機器", "#E4DFEC", 0, "#8064A2", 2, "#111111");
}
