...
// Source contract SHA-256: 10911adfb61fe56edfe7c5d97a2e0db19ee232a38556c58aa44dd1f2dad16ede
...
function main(workbook: ExcelScript.Workbook) {
  ...
  const baselineCanvasRowCount = 52;
  formatDiagramGrid(anchor, baselineCanvasRowCount, canvasColumnCount);

  const laneRange1 = getAnchoredRange(anchor, 0, 0, 1, 7);
  const laneRange2 = getAnchoredRange(anchor, 0, 7, 1, 11);
  const laneRange3 = getAnchoredRange(anchor, 0, 18, 1, 7);
  ...
  const geometryBottom = placeMermaidGeometry([shape_d61_OPERATION_O6, shape_d61_STOP_T2, shape_d61_OPERATION_O3, shape_d61_STOP_T5, shape_d61_OPERATION_O4, shape_d61_START_S6, shape_d61_START_S2, shape_d61_START_S5, shape_d61_STOP_T6, shape_d61_START_S3, shape_d61_STOP_T4, shape_d61_START_S4, shape_d61_OPERATION_COMM_ERROR, shape_d61_OPERATION_EVENT, shape_d61_OPERATION_O2, shape_d61_OPERATION_O5, shape_d61_START_START_ERROR, shape_d61_STOP_T1, shape_d61_OPERATION_O1, shape_d61_STOP_T3, shape_d61_STOP_T7, shape_d61_START_S1, shape_d61_START_S7], [553.983437, 779.411113, 445.381864, 819.154494, 436.451589, 168.449017, 106.449017, 106.449017, 807.645626, 106.449017, 756.883634, 106.449017, 446.015678, 520.35338, 445.381864, 302.8875, 164.898034, 714.6375, 493.920091, 756.883634, 714.6375, 106.449017, 48], [737.948973, 138.274356, 301.917519, 565.291568, 428.116907, 601.467715, 173.63792, 516.872521, 791.070162, 293.59668, 464.054696, 405.2346, 653.353779, 490.116907, 165.317082, 653.353779, 826.704587, 62, 62, 360.737615, 894.387243, 62, 826.704587], anchor.getLeft(), originTop);
  ...
  const edge_d61_05_START_S5_to_START_S6 = addConnector(sheet, "edge_d61_05_START_S5_to_START_S6", shape_d61_START_S5, shape_d61_START_S6, false, false, "⑤ 通信・対象デバイスを準備 → ⑥ 起動準備が", "", "elbow", "", "", "#548235", 2);
  ...
  const edge_d61_07_START_S6_to_START_START_ERROR = addConnector(sheet, "edge_d61_07_START_S6_to_START_START_ERROR", shape_d61_START_S6, shape_d61_START_START_ERROR, true, false, "いいえ", "いいえ", "elbow", "", "", "#C00000", 2);
  ...
  const edge_d61_11_OPERATION_O4_to_OPERATION_O5 = addConnector(sheet, "edge_d61_11_OPERATION_O4_to_OPERATION_O5", shape_d61_OPERATION_O4, shape_d61_OPERATION_O5, false, false, "はい", "はい", "elbow", "left", "left", "#1F4E79", 2);
  ...
  const edge_d61_13_OPERATION_O4_to_OPERATION_COMM_ERROR = addConnector(sheet, "edge_d61_13_OPERATION_O4_to_OPERATION_COMM_ERROR", shape_d61_OPERATION_O4, shape_d61_OPERATION_COMM_ERROR, true, false, "いいえ", "いいえ", "elbow", "right", "right", "#C00000", 2);
  ...
  const edge_d61_15_OPERATION_O6_to_OPERATION_O1 = addConnector(sheet, "edge_d61_15_OPERATION_O6_to_OPERATION_O1", shape_d61_OPERATION_O6, shape_d61_OPERATION_O1, false, false, "はい", "はい", "elbow", "left", "left", "#1F4E79", 2);
  const edge_d61_16_OPERATION_O3_to_OPERATION_EVENT = addConnector(sheet, "edge_d61_16_OPERATION_O3_to_OPERATION_EVENT", shape_d61_OPERATION_O3, shape_d61_OPERATION_EVENT, true, false, "デバイス処理結果", "デバイス処理結果", "elbow", "right", "right", "#C65911", 2);
  ...
  const edge_d61_18_STOP_T2_to_STOP_T7 = addConnector(sheet, "edge_d61_18_STOP_T2_to_STOP_T7", shape_d61_STOP_T2, shape_d61_STOP_T7, false, false, "いいえ", "いいえ", "elbow", "left", "left", "#548235", 2);
  const edge_d61_19_STOP_T2_to_STOP_T3 = addConnector(sheet, "edge_d61_19_STOP_T2_to_STOP_T3", shape_d61_STOP_T2, shape_d61_STOP_T3, false, false, "はい", "はい", "elbow", "", "", "#548235", 2);
  ...
  const edge_d61_22_STOP_T5_to_STOP_T7 = addConnector(sheet, "edge_d61_22_STOP_T5_to_STOP_T7", shape_d61_STOP_T5, shape_d61_STOP_T7, false, false, "はい", "はい", "elbow", "right", "right", "#548235", 2);
  const edge_d61_23_STOP_T5_to_STOP_T6 = addConnector(sheet, "edge_d61_23_STOP_T5_to_STOP_T6", shape_d61_STOP_T5, shape_d61_STOP_T6, true, false, "いいえ", "いいえ", "elbow", "", "", "#C00000", 2);
  const edge_d61_24_STOP_T6_to_STOP_T7 = addConnector(sheet, "edge_d61_24_STOP_T6_to_STOP_T7", shape_d61_STOP_T6, shape_d61_STOP_T7, false, false, "⑥ 所有プロセスツリーを → ⑦ 終了処理完了", "", "elbow", "", "", "#548235", 2);
  const edge_d61_25_START_S7_to_OPERATION_O1 = addConnector(sheet, "edge_d61_25_START_S7_to_OPERATION_O1", shape_d61_START_S7, shape_d61_OPERATION_O1, false, false, "⑦ 運用開始 → ① デバイス操作を依頼", "", "elbow", "right", "left", "#548235", 2);
...
function addCellLaneTable(anchor: ExcelScript.Range, bodyEndRowOffset: number) {
  addLaneColumns(anchor, 0, 7, bodyEndRowOffset, "（1） 起動フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 7, 11, bodyEndRowOffset, "（2） デバイス操作フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 18, 7, bodyEndRowOffset, "（3） 終了フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
}
