...
// Source contract SHA-256: a45207cbb5c0e45f022a3bdade1c3d8529d40caff8ef2868a18c8b43023cd355
...
function main(workbook: ExcelScript.Workbook) {
  ...
  const canvasColumnCount = 105;
  const baselineCanvasRowCount = 17;
  formatDiagramGrid(anchor, baselineCanvasRowCount, canvasColumnCount);

  const laneRange1 = getAnchoredRange(anchor, 0, 0, 1, 35);
  const laneRange2 = getAnchoredRange(anchor, 0, 35, 1, 35);
  const laneRange3 = getAnchoredRange(anchor, 0, 70, 1, 35);
  ...
  const shape_d61_OPERATION_O3 = addTextShape(sheet, "shape_d61_OPERATION_O3", "③ 順序制御して\n対象デバイスを制御\n決済端末とレシートプリンターは\nWindows OPOSを利用", 0, 0, 169.5, 66, 10, true, "#FCE4D6", 0, "#ED7D31", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_OPERATION_O3, "③ 順序制御して 対象デバイスを制御 決済端末とレシートプリンターは Windows OPOSを利用", "");
  ...
  const shape_d61_OPERATION_EVENT = addTextShape(sheet, "shape_d61_OPERATION_EVENT", "⑧ 非同期イベントを発行し\n受信処理が受信\n現行：購読先未登録", 0, 0, 143.775, 51, 10, true, "#FCE4D6", 0, "#ED7D31", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_OPERATION_EVENT, "⑧ 非同期イベントを発行し 受信処理が受信 現行：購読先未登録", "");
  ...
  const shape_d61_START_S7 = addTextShape(sheet, "shape_d61_START_S7", "⑦ イベント受信を開始して\n運用開始", 0, 0, 143.775, 36, 10, true, "#DDEBF7", 0, "#5B9BD5", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_START_S7, "⑦ イベント受信を開始して 運用開始", "");
  ...
  const shape_d61_STOP_T1 = addTextShape(sheet, "shape_d61_STOP_T1", "① アプリ停止・強制終了\nイベント受信を停止", 0, 0, 133.275, 36, 10, true, "#DDEBF7", 0, "#5B9BD5", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_STOP_T1, "① アプリ停止・強制終了 イベント受信を停止", "");
  ...
  const geometryBottom = placeMermaidGeometry([shape_d61_OPERATION_O6, shape_d61_STOP_T2, shape_d61_OPERATION_O3, shape_d61_STOP_T5, shape_d61_START_S6, shape_d61_OPERATION_O4, shape_d61_START_S2, shape_d61_OPERATION_EVENT, shape_d61_START_S5, shape_d61_START_S7, shape_d61_START_S3, shape_d61_STOP_T1, shape_d61_STOP_T6, shape_d61_START_S4, shape_d61_STOP_T4, shape_d61_OPERATION_COMM_ERROR, shape_d61_OPERATION_O2, shape_d61_OPERATION_O5, shape_d61_START_START_ERROR, shape_d61_OPERATION_O1, shape_d61_STOP_T3, shape_d61_STOP_T7, shape_d61_START_S1], [2435.220551, 2832.553609, 1673.978244, 3387.336313, 1030.123036, 2027.402769, 215.398048, 1964.62233, 783.093391, 1184.010536, 410.88136, 2586.6375, 3535.776807, 593.622081, 3118.798401, 2185.38238, 1491.424027, 2185.38238, 1184.010536, 1321.3875, 2952.908839, 3702.061318, 48], [164.72034, 74, 196.606989, 116.838256, 74, 74, 136.780439, 256.433538, 136.780439, 98.865332, 136.780439, 139.588965, 206.573966, 136.780439, 179.892965, 174.695546, 196.606989, 98.865332, 174.695546, 237.609684, 181.576291, 141.272291, 138.463765], anchor.getLeft(), originTop);
  ...
  const edge_d61_01_START_S1_to_START_S2 = addConnector(sheet, "edge_d61_01_START_S1_to_START_S2", shape_d61_START_S1, shape_d61_START_S2, false, false, "① アプリ起動 → ② 設定を準備", "", "elbow", "", "", "#548235", 2);
  const edge_d61_02_START_S2_to_START_S3 = addConnector(sheet, "edge_d61_02_START_S2_to_START_S3", shape_d61_START_S2, shape_d61_START_S3, false, false, "② 設定を準備 → ③ 既存プロセスを確認し", "", "elbow", "", "", "#548235", 2);
  const edge_d61_03_START_S3_to_START_S4 = addConnector(sheet, "edge_d61_03_START_S3_to_START_S4", shape_d61_START_S3, shape_d61_START_S4, false, false, "③ 既存プロセスを確認し → ④ デバイスコネクタは", "", "elbow", "", "", "#548235", 2);
  const edge_d61_04_START_S4_to_START_S5 = addConnector(sheet, "edge_d61_04_START_S4_to_START_S5", shape_d61_START_S4, shape_d61_START_S5, false, false, "④ デバイスコネクタは → ⑤ 通信・対象デバイスを準備", "", "elbow", "", "", "#548235", 2);
  const edge_d61_05_START_S5_to_START_S6 = addConnector(sheet, "edge_d61_05_START_S5_to_START_S6", shape_d61_START_S5, shape_d61_START_S6, false, false, "⑤ 通信・対象デバイスを準備 → ⑥ 起動準備が", "", "elbow", "left", "left", "#548235", 2);
  const edge_d61_06_START_S6_to_START_S7 = addConnector(sheet, "edge_d61_06_START_S6_to_START_S7", shape_d61_START_S6, shape_d61_START_S7, false, false, "はい", "はい", "elbow", "", "", "#548235", 2);
  const edge_d61_07_START_S6_to_START_START_ERROR = addConnector(sheet, "edge_d61_07_START_S6_to_START_START_ERROR", shape_d61_START_S6, shape_d61_START_START_ERROR, true, false, "いいえ", "いいえ", "elbow", "right", "right", "#C00000", 2);
  const edge_d61_08_OPERATION_O1_to_OPERATION_O2 = addConnector(sheet, "edge_d61_08_OPERATION_O1_to_OPERATION_O2", shape_d61_OPERATION_O1, shape_d61_OPERATION_O2, false, false, "① デバイス操作を依頼 → ② 接続を確認して", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_09_OPERATION_O2_to_OPERATION_O3 = addConnector(sheet, "edge_d61_09_OPERATION_O2_to_OPERATION_O3", shape_d61_OPERATION_O2, shape_d61_OPERATION_O3, false, false, "② 接続を確認して → ③ 順序制御して", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_10_OPERATION_O3_to_OPERATION_O4 = addConnector(sheet, "edge_d61_10_OPERATION_O3_to_OPERATION_O4", shape_d61_OPERATION_O3, shape_d61_OPERATION_O4, false, false, "③ 順序制御して → ④ 同期結果を", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_11_OPERATION_O4_to_OPERATION_O5 = addConnector(sheet, "edge_d61_11_OPERATION_O4_to_OPERATION_O5", shape_d61_OPERATION_O4, shape_d61_OPERATION_O5, false, false, "はい", "はい", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_12_OPERATION_O5_to_OPERATION_O6 = addConnector(sheet, "edge_d61_12_OPERATION_O5_to_OPERATION_O6", shape_d61_OPERATION_O5, shape_d61_OPERATION_O6, false, false, "⑤ 正常応答または → ⑦ 運用を継続するか", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_13_OPERATION_O4_to_OPERATION_COMM_ERROR = addConnector(sheet, "edge_d61_13_OPERATION_O4_to_OPERATION_COMM_ERROR", shape_d61_OPERATION_O4, shape_d61_OPERATION_COMM_ERROR, true, false, "いいえ", "いいえ", "elbow", "", "", "#C00000", 2);
  const edge_d61_14_OPERATION_COMM_ERROR_to_OPERATION_O6 = addConnector(sheet, "edge_d61_14_OPERATION_COMM_ERROR_to_OPERATION_O6", shape_d61_OPERATION_COMM_ERROR, shape_d61_OPERATION_O6, false, false, "⑥ 通信失敗を返却 → ⑦ 運用を継続するか", "", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_15_OPERATION_O6_to_OPERATION_O1 = addConnector(sheet, "edge_d61_15_OPERATION_O6_to_OPERATION_O1", shape_d61_OPERATION_O6, shape_d61_OPERATION_O1, false, false, "はい", "はい", "elbow", "", "", "#1F4E79", 2);
  const edge_d61_16_OPERATION_O3_to_OPERATION_EVENT = addConnector(sheet, "edge_d61_16_OPERATION_O3_to_OPERATION_EVENT", shape_d61_OPERATION_O3, shape_d61_OPERATION_EVENT, true, false, "デバイス処理結果", "デバイス処理結果", "elbow", "", "", "#C65911", 2);
  const edge_d61_17_STOP_T1_to_STOP_T2 = addConnector(sheet, "edge_d61_17_STOP_T1_to_STOP_T2", shape_d61_STOP_T1, shape_d61_STOP_T2, false, false, "① アプリ停止・強制終了 → ② 所有プロセスか", "", "elbow", "", "", "#548235", 2);
  const edge_d61_18_STOP_T2_to_STOP_T7 = addConnector(sheet, "edge_d61_18_STOP_T2_to_STOP_T7", shape_d61_STOP_T2, shape_d61_STOP_T7, false, false, "いいえ", "いいえ", "elbow", "", "", "#548235", 2);
  const edge_d61_19_STOP_T2_to_STOP_T3 = addConnector(sheet, "edge_d61_19_STOP_T2_to_STOP_T3", shape_d61_STOP_T2, shape_d61_STOP_T3, false, false, "はい", "はい", "elbow", "left", "left", "#548235", 2);
  const edge_d61_20_STOP_T3_to_STOP_T4 = addConnector(sheet, "edge_d61_20_STOP_T3_to_STOP_T4", shape_d61_STOP_T3, shape_d61_STOP_T4, false, false, "③ 停止要求を送信 → ④ デバイスコネクタが", "", "elbow", "", "", "#548235", 2);
  const edge_d61_21_STOP_T4_to_STOP_T5 = addConnector(sheet, "edge_d61_21_STOP_T4_to_STOP_T5", shape_d61_STOP_T4, shape_d61_STOP_T5, false, false, "④ デバイスコネクタが → ⑤ 10秒以内に", "", "elbow", "", "", "#548235", 2);
  const edge_d61_22_STOP_T5_to_STOP_T7 = addConnector(sheet, "edge_d61_22_STOP_T5_to_STOP_T7", shape_d61_STOP_T5, shape_d61_STOP_T7, false, false, "はい", "はい", "elbow", "", "", "#548235", 2);
  const edge_d61_23_STOP_T5_to_STOP_T6 = addConnector(sheet, "edge_d61_23_STOP_T5_to_STOP_T6", shape_d61_STOP_T5, shape_d61_STOP_T6, true, false, "いいえ", "いいえ", "elbow", "right", "right", "#C00000", 2);
  const edge_d61_24_STOP_T6_to_STOP_T7 = addConnector(sheet, "edge_d61_24_STOP_T6_to_STOP_T7", shape_d61_STOP_T6, shape_d61_STOP_T7, false, false, "⑥ 所有プロセスツリーを → ⑦ 終了処理完了", "", "elbow", "left", "left", "#548235", 2);
  const edge_d61_25_START_S7_to_OPERATION_O1 = addConnector(sheet, "edge_d61_25_START_S7_to_OPERATION_O1", shape_d61_START_S7, shape_d61_OPERATION_O1, false, false, "⑦ イベント受信を開始して → ① デバイス操作を依頼", "", "elbow", "right", "left", "#548235", 2);
  const edge_d61_26_OPERATION_O6_to_STOP_T1 = addConnector(sheet, "edge_d61_26_OPERATION_O6_to_STOP_T1", shape_d61_OPERATION_O6, shape_d61_STOP_T1, false, false, "いいえ", "いいえ", "elbow", "right", "left", "#548235", 2);
...
function addCellLaneTable(anchor: ExcelScript.Range, bodyEndRowOffset: number) {
  addLaneColumns(anchor, 0, 35, bodyEndRowOffset, "（1） 起動フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 35, 35, bodyEndRowOffset, "（2） デバイス操作フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 70, 35, bodyEndRowOffset, "（3） 終了フェーズ", "#FFFFFF", 0, "#4472C4", 2, "#111111");
}
