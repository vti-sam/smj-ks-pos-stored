function main(workbook: ExcelScript.Workbook, sheetName: string = "06_運用シナリオ_01", anchorAddress: string = "B7", pdfReviewMode: boolean = false) {
  ...
  const shape_d61_OPERATION_O1 = addTextShape(sheet, "shape_d61_OPERATION_O1", "① デバイス操作を依頼", 0, 0, 122.775, 28, 10, true, "#E2F0D9", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_OPERATION_O1, "① デバイス操作を依頼", "");
  const shape_d61_STOP_T1 = addTextShape(sheet, "shape_d61_STOP_T1", "① アプリ停止・破棄", 0, 0, 112.275, 28, 10, true, "#DDEBF7", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_STOP_T1, "① アプリ停止・破棄", "");
  const shape_d61_STOP_T3 = addTextShape(sheet, "shape_d61_STOP_T3", "③ 停止要求を送信", 0, 0, 101.775, 28, 10, true, "#DDEBF7", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_STOP_T3, "③ 停止要求を送信", "");
  const shape_d61_START_S1 = addTextShape(sheet, "shape_d61_START_S1", "① アプリ起動", 0, 0, 96, 28, 10, true, "#DDEBF7", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_START_S1, "① アプリ起動", "");
  const shape_d61_STOP_T7 = addTextShape(sheet, "shape_d61_STOP_T7", "終了処理完了", 0, 0, 96, 28, 10, true, "#DDEBF7", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_STOP_T7, "終了処理完了", "");
  const shape_d61_START_S7 = addTextShape(sheet, "shape_d61_START_S7", "運用開始", 0, 0, 96, 28, 10, true, "#DDEBF7", true, "center", "roundRect", false);
  setShapeAltText(shape_d61_START_S7, "運用開始", "");

  let groupBottom1 = placeD2Row([shape_d61_START_S1], [0.483741], laneRange1.getLeft(), originTop + 90, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S2], [0.483741], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S3], [0.483741], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S4], [0.483741], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S5], [0.483741], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S6], [0.730947], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  groupBottom1 = placeD2Row([shape_d61_START_S7, shape_d61_START_START_ERROR], [0.27981, 0.687672], laneRange1.getLeft(), groupBottom1 + 24, laneRange1.getWidth(), 30, 28);
  ...
  let groupBottom3 = placeD2Row([shape_d61_STOP_T1], [0.401511], laneRange3.getLeft(), originTop + 90, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T2], [0.625982], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T3], [0.547247], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T4], [0.547247], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T5], [0.763045], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T6], [0.710367], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  groupBottom3 = placeD2Row([shape_d61_STOP_T7], [0.401511], laneRange3.getLeft(), groupBottom3 + 24, laneRange3.getWidth(), 30, 28);
  ...
  addConnector(sheet, "edge_d61_02_START_S7_to_OPERATION_O1", shape_d61_START_S7, shape_d61_OPERATION_O1, false, false, "", "elbow", "right", "left", "#548235");
  addConnector(sheet, "edge_d61_03_STOP_T1_to_STOP_T2", shape_d61_STOP_T1, shape_d61_STOP_T2, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_04_STOP_T2_to_STOP_T7", shape_d61_STOP_T2, shape_d61_STOP_T7, false, false, "いいえ", "elbow", "left", "left", "#548235");
  ...
  addConnector(sheet, "edge_d61_07_STOP_T4_to_STOP_T5", shape_d61_STOP_T4, shape_d61_STOP_T5, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_08_STOP_T5_to_STOP_T7", shape_d61_STOP_T5, shape_d61_STOP_T7, false, false, "はい", "elbow", "right", "right", "#548235");
  addConnector(sheet, "edge_d61_09_STOP_T5_to_STOP_T6", shape_d61_STOP_T5, shape_d61_STOP_T6, true, false, "いいえ", "elbow", "", "", "#C00000");
  addConnector(sheet, "edge_d61_10_STOP_T6_to_STOP_T7", shape_d61_STOP_T6, shape_d61_STOP_T7, false, false, "", "elbow", "", "", "#C00000");
  addConnector(sheet, "edge_d61_11_OPERATION_O1_to_OPERATION_O2", shape_d61_OPERATION_O1, shape_d61_OPERATION_O2, false, false, "", "elbow", "", "", "#1F4E79");
  addConnector(sheet, "edge_d61_12_OPERATION_O2_to_OPERATION_O3", shape_d61_OPERATION_O2, shape_d61_OPERATION_O3, false, false, "", "elbow", "", "", "#1F4E79");
  addConnector(sheet, "edge_d61_13_OPERATION_O3_to_OPERATION_O4", shape_d61_OPERATION_O3, shape_d61_OPERATION_O4, false, false, "", "elbow", "", "", "#1F4E79");
  addConnector(sheet, "edge_d61_14_OPERATION_O4_to_OPERATION_O5", shape_d61_OPERATION_O4, shape_d61_OPERATION_O5, false, false, "はい", "elbow", "left", "left", "#1F4E79");
  addConnector(sheet, "edge_d61_15_OPERATION_O5_to_OPERATION_O6", shape_d61_OPERATION_O5, shape_d61_OPERATION_O6, false, false, "", "elbow", "", "", "#1F4E79");
  addConnector(sheet, "edge_d61_16_OPERATION_O4_to_OPERATION_COMM_ERROR", shape_d61_OPERATION_O4, shape_d61_OPERATION_COMM_ERROR, true, false, "いいえ", "elbow", "right", "right", "#C00000");
  addConnector(sheet, "edge_d61_17_OPERATION_COMM_ERROR_to_OPERATION_O6", shape_d61_OPERATION_COMM_ERROR, shape_d61_OPERATION_O6, false, false, "", "elbow", "", "", "#C00000");
  addConnector(sheet, "edge_d61_18_OPERATION_O6_to_OPERATION_O1", shape_d61_OPERATION_O6, shape_d61_OPERATION_O1, false, false, "はい", "elbow", "left", "left", "#1F4E79");
  addConnector(sheet, "edge_d61_19_OPERATION_O3_to_OPERATION_EVENT", shape_d61_OPERATION_O3, shape_d61_OPERATION_EVENT, true, false, "デバイス処理結果", "elbow", "right", "right", "#C65911");
  addConnector(sheet, "edge_d61_20_START_S1_to_START_S2", shape_d61_START_S1, shape_d61_START_S2, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_21_START_S2_to_START_S3", shape_d61_START_S2, shape_d61_START_S3, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_22_START_S3_to_START_S4", shape_d61_START_S3, shape_d61_START_S4, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_23_START_S4_to_START_S5", shape_d61_START_S4, shape_d61_START_S5, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_24_START_S5_to_START_S6", shape_d61_START_S5, shape_d61_START_S6, false, false, "", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_25_START_S6_to_START_S7", shape_d61_START_S6, shape_d61_START_S7, false, false, "はい", "elbow", "", "", "#548235");
  addConnector(sheet, "edge_d61_26_START_S6_to_START_START_ERROR", shape_d61_START_S6, shape_d61_START_START_ERROR, true, false, "いいえ", "elbow", "", "", "#C00000");
