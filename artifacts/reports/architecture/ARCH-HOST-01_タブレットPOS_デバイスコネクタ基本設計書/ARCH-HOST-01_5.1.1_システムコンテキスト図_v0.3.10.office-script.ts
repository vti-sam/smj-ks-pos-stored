...
function main(workbook: ExcelScript.Workbook) {
  ...
  const edge_d511_02_HOST_to_APP = addConnector(sheet, "edge_d511_02_HOST_to_APP", shape_d511_HOST, shape_d511_APP, true, false, "イベント通知用パイプ 非同期イベント（コネクタ→DeviceCtrl受信処理）", "イベント通知用パイプ 非同期イベント（コネクタ→DeviceCtrl受信処理）", "elbow", "bottom", "bottom", "#C65911", 2);
