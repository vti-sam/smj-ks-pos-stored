...
function main(workbook: ExcelScript.Workbook, sheetName: string = "06_運用シナリオ_01", anchorAddress: string = "B7", downloadPdf: boolean = false, pdfFileName: string = "6.1 運用シナリオ図.pdf") {
  ...
  const reviewRight = reviewLeft + 36 * 36;
  const reviewBottom = reviewTop + 31 * 18;
  const edgeSourcePrefix = "edge_d61_";
  const shapeSourcePrefix = "shape_d61_";
