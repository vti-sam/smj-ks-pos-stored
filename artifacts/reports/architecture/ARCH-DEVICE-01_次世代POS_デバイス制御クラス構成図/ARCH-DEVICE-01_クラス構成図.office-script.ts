...
function main(workbook: ExcelScript.Workbook) {
  ...
  const canvasColumnCount = 88;
  const baselineCanvasRowCount = 21;
  formatDiagramGrid(anchor, baselineCanvasRowCount, canvasColumnCount);

  const laneRange1 = getAnchoredRange(anchor, 0, 0, 1, 10);
  const laneRange2 = getAnchoredRange(anchor, 0, 10, 1, 47);
  const laneRange3 = getAnchoredRange(anchor, 0, 57, 1, 19);
  const laneRange4 = getAnchoredRange(anchor, 0, 76, 1, 12);

  addCellLaneTable(anchor, baselineCanvasRowCount - 1);

  const shape_d51_APP_BOOT = addTextShape(sheet, "shape_d51_APP_BOOT", "① 構成ルート・ライフサイクル\n（MauiProgram / App）", 0, 0, 164.775, 36, 10, true, "#F8FBFD", 0, "#0D32B2", 2, "#111111", true, "center", "roundRect", false);
  ...
  const shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT = addTextShape(sheet, "shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT", "①-4 コマンド通信\n（INamedPipeClient / NamedPipeClient）", 0, 0, 229.35, 36, 10, true, "#F8FBFD", 0, "#0D32B2", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, "①-4 コマンド通信 （INamedPipeClient / NamedPipeClient）", "");
  const shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER = addTextShape(sheet, "shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER", "①-5 イベント受信\n（IDeviceEventReceiver /\nNamedPipeEventReceiver）", 0, 0, 149.55, 51, 10, true, "#F8FBFD", 0, "#0D32B2", 2, "#111111", true, "center", "roundRect", false);
  setShapeAltText(shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, "①-5 イベント受信 （IDeviceEventReceiver / NamedPipeEventReceiver）", "");
  ...
  const geometryBottom = placeMermaidGeometry([shape_d51_APP_BOOT, shape_d51_APP_SERVICE, shape_d51_DEVICE_CTRL_CORE_CONFIG_GROUP_MODEL, shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID, shape_d51_EXTERNAL_WIN_OPOS_DEVICE, shape_d51_EXTERNAL_MOBILE_DEVICE, shape_d51_DEVICE_CTRL_CORE_OPOS_CLIENT, shape_d51_DEVICE_CTRL_CORE_CONFIG_GROUP_CONFIG, shape_d51_DEVICE_CTRL_CORE_CONTRACTS, shape_d51_DEVICE_CTRL_CORE_CONFIG_GROUP_DEFAULT, shape_d51_EXTERNAL_WIN_DIRECT_DEVICE, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, shape_d51_DEVICE_CTRL_CORE_CONFIG_GROUP_RUNTIME, shape_d51_EXTERNAL_CONNECTOR, shape_d51_DEVICE_CTRL_CORE_MANAGER, shape_d51_APP_VIEW], [258.504238, 258.504238, 913.380491, 1445.703604, 1944.665868, 2367.02346, 2367.02346, 2367.02346, 3060.339623, 2815.5, 1194.445644, 666.832031, 913.380491, 429, 2815.5, 2367.02346, 2120.475, 2648.088613, 913.380491, 2815.5, 429, 48], [66, 253.400943, 153.5, 302.608491, 223.70283, 92, 240.528302, 308.990566, 124.018868, 182.037736, 298.837264, 101.283019, 328.136792, 92, 120.537736, 179.028302, 225.733491, 127.681604, 92, 66, 250.971698, 253.400943], anchor.getLeft(), originTop);
  ...
  const edge_d51_07_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY = addConnector(sheet, "edge_d51_07_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY", shape_d51_DEVICE_CTRL_CORE_MANAGER, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY, false, false, "①-2 デバイス管理 → ②-1 ストラテジー生成", "", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d51_08_APP_BOOT_to_DEVICE_CTRL_CORE_MANAGER = addConnector(sheet, "edge_d51_08_APP_BOOT_to_DEVICE_CTRL_CORE_MANAGER", shape_d51_APP_BOOT, shape_d51_DEVICE_CTRL_CORE_MANAGER, false, false, "InitializeAsync", "InitializeAsync", "elbow", "right", "left", "#548235", 2);
  const edge_d51_09_APP_BOOT_to_DEVICE_CTRL_CORE_EVENT_RECEIVER = addConnector(sheet, "edge_d51_09_APP_BOOT_to_DEVICE_CTRL_CORE_EVENT_RECEIVER", shape_d51_APP_BOOT, shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, false, false, "StartAsync / StopAsync", "StartAsync / StopAsync", "elbow", "right", "left", "#548235", 2);
  ...
  const edge_d51_11_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_CORE_PIPE_CLIENT = addConnector(sheet, "edge_d51_11_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_CORE_PIPE_CLIENT", shape_d51_DEVICE_CTRL_CORE_MANAGER, shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, true, false, "通信設定を適用", "通信設定を適用", "elbow", "right", "right", "#7F7F7F", 2);
  const edge_d51_12_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_CORE_EVENT_RECEIVER = addConnector(sheet, "edge_d51_12_DEVICE_CTRL_CORE_MANAGER_to_DEVICE_CTRL_CORE_EVENT_RECEIVER", shape_d51_DEVICE_CTRL_CORE_MANAGER, shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, true, false, "通信設定を適用", "通信設定を適用", "elbow", "left", "left", "#7F7F7F", 2);
  const edge_d51_13_APP_SERVICE_to_DEVICE_CTRL_CORE_MANAGER = addConnector(sheet, "edge_d51_13_APP_SERVICE_to_DEVICE_CTRL_CORE_MANAGER", shape_d51_APP_SERVICE, shape_d51_DEVICE_CTRL_CORE_MANAGER, false, false, "Get...StrategyAsync", "Get...StrategyAsync", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d51_14_APP_SERVICE_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT = addConnector(sheet, "edge_d51_14_APP_SERVICE_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT", shape_d51_APP_SERVICE, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, false, false, "Start / デバイス操作 / End", "Start / デバイス操作 / End", "elbow", "right", "left", "#1F4E79", 2);
  const edge_d51_15_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR = addConnector(sheet, "edge_d51_15_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR, false, false, "生成", "生成", "elbow", "left", "left", "#1F4E79", 2);
  const edge_d51_16_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT = addConnector(sheet, "edge_d51_16_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT, false, false, "生成", "生成", "elbow", "right", "right", "#1F4E79", 2);
  const edge_d51_17_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS = addConnector(sheet, "edge_d51_17_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY_to_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_FACTORY, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS, false, false, "生成", "生成", "elbow", "left", "left", "#1F4E79", 2);
  ...
  const edge_d51_19_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT = addConnector(sheet, "edge_d51_19_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, false, false, "実装", "実装", "elbow", "", "", "#1F4E79", 2);
  const edge_d51_20_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT = addConnector(sheet, "edge_d51_20_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_DIRECT, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, false, false, "実装", "実装", "elbow", "left", "left", "#1F4E79", 2);
  const edge_d51_21_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT = addConnector(sheet, "edge_d51_21_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, false, false, "実装", "実装", "elbow", "right", "right", "#1F4E79", 2);
  const edge_d51_22_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT = addConnector(sheet, "edge_d51_22_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID_to_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID, shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_CONTRACT, false, false, "実装", "実装", "elbow", "left", "left", "#1F4E79", 2);
  const edge_d51_23_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR_to_DEVICE_CTRL_CORE_OPOS_CLIENT = addConnector(sheet, "edge_d51_23_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR_to_DEVICE_CTRL_CORE_OPOS_CLIENT", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_WIN_CONNECTOR, shape_d51_DEVICE_CTRL_CORE_OPOS_CLIENT, false, false, "コマンドと結果を変換", "コマンドと結果を変換", "elbow", "left", "right", "#1F4E79", 2);
  const edge_d51_24_DEVICE_CTRL_CORE_OPOS_CLIENT_to_DEVICE_CTRL_CORE_PIPE_CLIENT = addConnector(sheet, "edge_d51_24_DEVICE_CTRL_CORE_OPOS_CLIENT_to_DEVICE_CTRL_CORE_PIPE_CLIENT", shape_d51_DEVICE_CTRL_CORE_OPOS_CLIENT, shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, false, false, "要求を送信", "要求を送信", "elbow", "", "", "#1F4E79", 2);
  const edge_d51_25_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_OPOS_CLIENT = addConnector(sheet, "edge_d51_25_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_OPOS_CLIENT", shape_d51_DEVICE_CTRL_CORE_CONTRACTS, shape_d51_DEVICE_CTRL_CORE_OPOS_CLIENT, true, false, "要求・応答DTO", "要求・応答DTO", "elbow", "right", "right", "#7F7F7F", 2);
  const edge_d51_26_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_PIPE_CLIENT = addConnector(sheet, "edge_d51_26_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_PIPE_CLIENT", shape_d51_DEVICE_CTRL_CORE_CONTRACTS, shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, true, false, "パイプ名・既定値", "パイプ名・既定値", "elbow", "left", "left", "#7F7F7F", 2);
  const edge_d51_27_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_EVENT_RECEIVER = addConnector(sheet, "edge_d51_27_DEVICE_CTRL_CORE_CONTRACTS_to_DEVICE_CTRL_CORE_EVENT_RECEIVER", shape_d51_DEVICE_CTRL_CORE_CONTRACTS, shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, true, false, "イベントDTO・既定値", "イベントDTO・既定値", "elbow", "", "", "#7F7F7F", 2);
  const edge_d51_28_DEVICE_CTRL_CORE_PIPE_CLIENT_to_EXTERNAL_CONNECTOR = addConnector(sheet, "edge_d51_28_DEVICE_CTRL_CORE_PIPE_CLIENT_to_EXTERNAL_CONNECTOR", shape_d51_DEVICE_CTRL_CORE_PIPE_CLIENT, shape_d51_EXTERNAL_CONNECTOR, false, true, "要求／同期応答 コマンド通信用パイプ", "要求／同期応答 コマンド通信用パイプ", "elbow", "right", "left", "#1F4E79", 3);
  const edge_d51_29_EXTERNAL_CONNECTOR_to_DEVICE_CTRL_CORE_EVENT_RECEIVER = addConnector(sheet, "edge_d51_29_EXTERNAL_CONNECTOR_to_DEVICE_CTRL_CORE_EVENT_RECEIVER", shape_d51_EXTERNAL_CONNECTOR, shape_d51_DEVICE_CTRL_CORE_EVENT_RECEIVER, true, false, "イベント通知用パイプ 非同期イベント", "イベント通知用パイプ 非同期イベント", "elbow", "left", "right", "#C65911", 2);
  const edge_d51_30_DEVICE_CTRL_CORE_CONTRACTS_to_EXTERNAL_CONNECTOR = addConnector(sheet, "edge_d51_30_DEVICE_CTRL_CORE_CONTRACTS_to_EXTERNAL_CONNECTOR", shape_d51_DEVICE_CTRL_CORE_CONTRACTS, shape_d51_EXTERNAL_CONNECTOR, true, false, "共通DTO・識別子", "共通DTO・識別子", "elbow", "right", "left", "#7F7F7F", 2);
  const edge_d51_31_EXTERNAL_CONNECTOR_to_EXTERNAL_WIN_OPOS_DEVICE = addConnector(sheet, "edge_d51_31_EXTERNAL_CONNECTOR_to_EXTERNAL_WIN_OPOS_DEVICE", shape_d51_EXTERNAL_CONNECTOR, shape_d51_EXTERNAL_WIN_OPOS_DEVICE, false, true, "実機制御／結果", "実機制御／結果", "elbow", "", "", "#7030A0", 2);
  ...
  const edge_d51_33_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS_to_EXTERNAL_MOBILE_DEVICE = addConnector(sheet, "edge_d51_33_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS_to_EXTERNAL_MOBILE_DEVICE", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_IOS, shape_d51_EXTERNAL_MOBILE_DEVICE, false, true, "実機制御／結果", "実機制御／結果", "elbow", "right", "left", "#7030A0", 2);
  const edge_d51_34_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID_to_EXTERNAL_MOBILE_DEVICE = addConnector(sheet, "edge_d51_34_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID_to_EXTERNAL_MOBILE_DEVICE", shape_d51_DEVICE_CTRL_STRATEGY_PATTERN_PLATFORM_ANDROID, shape_d51_EXTERNAL_MOBILE_DEVICE, false, true, "実機制御／結果", "実機制御／結果", "elbow", "right", "left", "#7030A0", 2);
...
function addCellLaneTable(anchor: ExcelScript.Range, bodyEndRowOffset: number) {
  ...
  addLaneColumns(anchor, 10, 47, bodyEndRowOffset, "① 共通制御・設定管理", "#F7FBFF", 0, "#4472C4", 2, "#111111");
  addLaneColumns(anchor, 57, 19, bodyEndRowOffset, "② ストラテジーパターン", "", 1, "#ED7D31", 2, "#111111");
  addLaneColumns(anchor, 76, 12, bodyEndRowOffset, "（3） 外部境界", "", 1, "#ED7D31", 2, "#111111");
}
