...
function main(workbook: ExcelScript.Workbook) {
  ...
  const expectedSheetBase = "07_プラットフォーム別クラス構成図_01";
  ...
  const shapePrefix = "shape_d71_";
  const edgePrefix = "edge_d71_";
  const sectionPrefix = "section_bg_d71_";
  const edgeLabelPrefix = "edge_label_d71_";
  const shapeGroupPrefix = "shape_group_d71_";
  const shapeCommentPrefix = "shape_comment_d71_";
  const edgeLabelAnchors: { [key: string]: number[] } = { "edge_d71_01_PLATFORM_DOMAIN_CONTRACT_to_PLATFORM_DOMAIN_PLATFORM": [0.5, 0.5], "edge_d71_02_PLATFORM_DOMAIN_PLATFORM_to_PLATFORM_DOMAIN_OPOS": [0.736687, 0], "edge_d71_03_PLATFORM_DOMAIN_PLATFORM_to_PLATFORM_DOMAIN_WIN_DIRECT": [0.254136, 0.5], "edge_d71_04_PLATFORM_DOMAIN_PLATFORM_to_PLATFORM_DOMAIN_IOS": [0.777102, 1], "edge_d71_05_PLATFORM_DOMAIN_PLATFORM_to_PLATFORM_DOMAIN_ANDROID": [0.365854, 0.5], "edge_d71_06_PLATFORM_DOMAIN_OPOS_to_PLATFORM_DOMAIN_OPOS_COMM": [0.941895, 0.496241], "edge_d71_07_PLATFORM_DOMAIN_DEVICE_CONTRACTS_to_PLATFORM_DOMAIN_OPOS_COMM": [0.5, 0.5], "edge_d71_08_PLATFORM_DOMAIN_OPOS_COMM_to_EXTERNAL_DOMAIN_CONNECTOR": [0.966565, 0.493048], "edge_d71_09_PLATFORM_DOMAIN_WIN_DIRECT_to_EXTERNAL_DOMAIN_WIN_API": [0.450084, 1], "edge_d71_10_PLATFORM_DOMAIN_IOS_to_EXTERNAL_DOMAIN_IOS_API": [0.450816, 1], "edge_d71_11_PLATFORM_DOMAIN_ANDROID_to_EXTERNAL_DOMAIN_ANDROID_API": [0.448322, 0.5] };
