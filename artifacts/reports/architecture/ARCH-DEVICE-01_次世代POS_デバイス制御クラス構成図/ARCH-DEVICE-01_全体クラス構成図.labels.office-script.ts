...
function main(workbook: ExcelScript.Workbook) {
  ...
  const expectedSheetBase = "05_全体クラス構成図_01";
  ...
  const edgeLabelAnchors: { [key: string]: number[] } = { "edge_d51_01_APP_VIEW_to_APP_SERVICE": [0.5, 0.5], "edge_d51_02_DEVICE_CTRL_MANAGER_to_DEVICE_CTRL_CONFIG": [0.58172, 0], "edge_d51_03_DEVICE_CTRL_MANAGER_to_DEVICE_CTRL_FACTORY": [0.5, 0.5], "edge_d51_04_DEVICE_CTRL_FACTORY_to_DEVICE_CTRL_CONTRACT": [0.5, 0.5], "edge_d51_05_APP_SERVICE_to_DEVICE_CTRL_MANAGER": [0.700994, 1], "edge_d51_06_APP_SERVICE_to_DEVICE_CTRL_CONTRACT": [0.537959, 1], "edge_d51_07_APP_BOOT_to_DEVICE_CTRL_MANAGER": [0.287865, 0.370466], "edge_d51_08_APP_BOOT_to_DEVICE_CTRL_EVENT": [0.706325, 0.744186] };
