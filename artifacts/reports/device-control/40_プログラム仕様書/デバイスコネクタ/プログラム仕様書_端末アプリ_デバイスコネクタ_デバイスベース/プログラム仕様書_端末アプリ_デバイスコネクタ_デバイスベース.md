# PS-CONNECTOR-07 タブレットPOS デバイスコネクタ デバイスベース プログラム仕様書
...
| 項目 | 内容 |
| --- | --- |
| 文書ID | PS-CONNECTOR-07 |
| 文書名 | タブレットPOS デバイスコネクタ デバイスベース プログラム仕様書 |
| 対象 | タブレットPOS / デバイスベース |
| 版数 | 0.1.1 |
| 作成日 | 2026/06/19 |
| 作成者 | SMJサム |
...
| ⑫ | public | int | Device_End(dynamic, bool, bool) | DataEventEnabled、DeviceEnabled、Release など読込終了状態を設定する。 |
| ⑬ | public | int | Device_End(dynamic, bool, bool, bool) | DataEventEnabled、DeviceEnabled、Release など読込終了状態を設定する。 |
...
| 項目 | 内容 |
| --- | --- |
| シグネチャ | [DllImport("user32")] public static extern int GetForegroundWindow() |
| 可視性 | public |
| 戻り値 | int |
...
### ⑬. Device_End(dynamic, bool, bool, bool)
