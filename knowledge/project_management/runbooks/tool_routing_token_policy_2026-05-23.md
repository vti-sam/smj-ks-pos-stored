...
- Với source code, dùng `skills/knowledge-code/source-code-intel/` để điều phối `rtk rg`, đọc file trực tiếp, build/test/compiler output và phân tích impact theo phạm vi task.
...
- Khi cần phân tích source code, bắt đầu bằng `skills/knowledge-code/source-code-intel/`; verify bằng `rtk rg`, build output, `.sln/.csproj`, compiler errors và đọc file liên quan.
