...
| S-011 | Vendor reviewer | VTI 吉田 | syuhei.yoshida@vti.com.vn | VTIジャパン | レビュー担当 | Medium | High | 担当資料の確認結果と修正要否を明確にする。 | Backlog上の関連Issueおよびレビュー依頼を確認し、必要な内容を連携する。 | Backlog KHアカウント: 吉田周平@VTIジャパン。 |
...
| S-009 | PMO reviewer | SMJ 門山 | 未確認 | ポールトゥウィン | PMO | High | High | 工数、進捗、課題および成果物の確認に必要な情報を把握する。 | Backlog上の関連Issue、進捗および確認事項を確認する。 | Backlog KHアカウント: SMJ門山。 |
| S-010 | PMO reviewer | SMJ 尹 | 未確認 | SMJ | PMO | High | High | 工数、進捗、課題および成果物の確認に必要な情報を把握する。 | Backlog上の関連Issue、進捗および確認事項を確認する。 | Backlog KHアカウント: SMJ尹。 |
