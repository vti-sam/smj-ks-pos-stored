...
Nội dung được đối chiếu bằng CodeGraph với `sources/TabetPosBoilerplate`, sau đó đọc source liên quan trực tiếp. Generated migration/designer không tách thành spec riêng; enum/constant nhỏ được mô tả trong spec liên quan để tài liệu dễ đọc hơn.
